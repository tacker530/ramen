...
def common_point(poly1, poly2)
  poly1['latLngs'].each_cons(2) do |point1, point2|
    poly2['latLngs'].each_cons(2) do |point3, point4|
      if same_point?(point1, point3) || same_point?(point1, point4) || 
         same_point?(point2, point3) || same_point?(point2, point4)
        return [point1, point2].find { |p| poly2['latLngs'].any? { |p2| same_point?(p, p2) } }
      end
    end
  end
  nil
